...
function showActions(actions, stance){
    ...
    document.querySelector("#beast").src = "beast.png";
}
//reset the game
...
function sword(){
    ...
    weaponStance = "sword_stance.png"
    battleAttack = "sword_slash.png";
    battlePotion = "sword_potion.png";
    battleMagic = "sword_magic.png";
    battleDeath = "sword_dead.png";
...
function bow(){
    ...
    weaponStance = "bow_stance.png"
    battleAttack = "bow_fire.png";
    battlePotion = "bow_potion.png";
    battleMagic = "bow_magic.png";
    battleDeath = "bow_dead.png";
...
function staff(){
    ...
    weaponStance = "staff_stance.png"
    battleAttack = "staff_swing.png";
    battlePotion = "staff_potion.png";
    battleMagic = "staff_magic.png";
    battleDeath = "staff_dead.png";
...
function healthBars(){
    //adds colours green, orange or red depending on the user and bosses health
        ...
        if(bossHealth <= 0 && charHealth > 0){
            ...
            document.querySelector("#beast").src = "dead_beast.png";
            playAudio();
